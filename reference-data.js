window.AUTO_CHESS_REFERENCE = {
  ...
  "pieces": [
    ...
    },
    {
      ...
      "name": "Eclipse of Darkness",
      "title": "Eclipse of Darkness",
      "cost": 3,
      "quality": "Rare",
      "races": [
        "Egersis"
    ...
    },
    {
      ...
      "name": "Penitent Bishop·Mammon",
      "title": "Penitent Bishop·Mammon",
      "cost": 3,
      "quality": "Rare",
      "races": [
        "Ancestor",
  ...
  "items": [
    {
      "id": "anti-maga-cloak",
      "name": "Anti-Maga Cloak",
      "quality": "Legendary",
      "categories": [
        "Defense"
      ],
      "attributes": "+20% Magic resistance",
      "effect": "Active: grants a shield that can block 150 Magical Damage for all allies within 2 grids for 5 seconds. CD: 30 seconds",
      "recipe": [
        "Resistance Cloak",
        "Resistance Cloak"
      ],
    ...
    },
    {
      ...
      "attributes": "+15% Attack speed\n+15% Evasion\n+35 ATK",
      "effect": "Passive: Deals Pure Damage equals to 30% of the Attack Damage to enemies within 2 grids with melee attacks",
      "recipe": [
        "Shadow Edge",
        "Ghost Blade"
      ],
    ...
    {
      "id": "barbaric-cuirass",
      "name": "Barbaric Cuirass",
      "quality": "Immortal",
      "categories": [
        "Defense"
      ],
      "attributes": "",
      "effect": "Passive: +8 armor and 15% attack speed to allies within 1 grid. In the meantime, -8 enemy's armor and 15% attack speed within the same scope",
      "recipe": [
        "Steel Platemail",
        "Wraith Shard"
      ],
    ...
    },
    {
      ...
      "attributes": "+5 Armor\n+10 ATK",
      "effect": "Active: Reflect 100% of the damage received in 4 seconds back to the attacker. Cooldown: 30 seconds.",
      "recipe": [
        "Broken Sword",
        "Cattlehide Armor"
      ],
    ...
    },
    {
      ...
      "attributes": "+10% Evasion Rate\n+25 ATK",
      "effect": "The carrier's ranged base attack will additionally attack 1 enemy within the range, dealing damage equals to 15% ATK.",
      "recipe": [
        "Broken Sword",
        "Lucky Coin"
      ],
    ...
    },
    {
      ...
      "attributes": "ATK +20\nHP +350\n+40% Mana Restoration on injury",
      "effect": "Active: Increases 100% Magic Resistance, and immune to Abilities for 9 seconds. CD: 30 seconds",
      "recipe": [
        "Python Wand",
        "Nether Essence"
      ],
    ...
    },
    {
      ...
      "attributes": "+15% Evasion\n+250 HP",
      "effect": "Active: Disarms the enemy which has the highest Attack for 3 seconds. CD: 30 seconds.",
      "recipe": [
        "Lucky Coin",
        "Life Crystal"
      ],
    ...
    },
    {
      ...
      "attributes": "+5% Lifesteal when dealing base attack",
      "effect": "",
      "recipe": "",
      "sourceUrl": "https://ac.dragonest.com/en/equipment",
      "source": "Official Dragonest Item Effects",
    ...
    },
    {
      ...
      "name": "Dragonbone Ballista",
      "quality": "Immortal",
      "categories": [
        "Physic"
      ],
      "attributes": "+40 ATK",
      "effect": "Passive: Base attack has a 10% chance to deal 4 times of damage",
      "recipe": [
        "Crystal Sword",
        "Ghost Blade"
      ],
    ...
    },
    {
      ...
      "attributes": "+250 HP",
      "effect": "Passive: Have a 50% chances to block 50 damage while being attacked",
      "recipe": [
        "Life Crystal",
        "Cattlehide Armor"
      ],
    ...
    },
    {
      ...
      "name": "Dragonthorn Bracer",
      "quality": "Epic",
      "categories": [
        "Magic",
        "Physic"
      ],
      "attributes": "Ability lifesteal +10%",
      "effect": "",
      "recipe": "",
      "sourceUrl": "https://ac.dragonest.com/en/equipment",
      "source": "Official Dragonest Item Effects",
    ...
    },
    {
      ...
      "attributes": "Non-Egersis carriers of Lv.5 or lower are immune to Plague (Egersis racial effect).\n[Pact Sealed]: If the carrier survives a home battle, at the start of the next round they will transform into a random Egersis piece of the same cost and star level.",
      "effect": "",
      "recipe": "",
      "sourceUrl": "https://ac.dragonest.com/en/equipment",
      "source": "Official Dragonest Item Effects",
    ...
    },
    {
      ...
      "attributes": "+20 ATK\n+100% Mana Restoration on hit\n+40% Mana Restoration on injury",
      "effect": "Active: Flashes to the farthest grid that can attack the enemy and gains 50 Mana, then reflects 100% of the damage received in 6 seconds back to the attacker. CD: 15 seconds",
      "recipe": [
        "Teleport Dagger",
        "Nether Essence"
      ],
    ...
    },
    {
      ...
      "attributes": "+10% Lifesteal when dealing base attack",
      "effect": "Passive: +40% attack speed. Silence the holder",
      "recipe": [
        "Dracula Mask",
        "Wooden Club"
      ],
    ...
    },
    {
      ...
      "name": "Halberd of Judgement",
      "quality": "Immortal",
      "categories": [
        "Defense"
      ],
      "attributes": "+15% Evasion\n+800 HP",
      "effect": "Active: Disarms the enemy which has the highest Attack for 5 seconds. CD: 30 seconds.",
      "recipe": [
        "Cloud Halberd",
        "Dragon Blood Axe"
      ],
    ...
    },
    {
      ...
      "attributes": "+15% Magica resistance",
      "effect": "Grants +20% Base Attack lifesteal and +20% Ability lifesteal for allies within 1 grid",
      "recipe": [
        "Puppet Mask",
        "Dragonthorn Bracer"
      ],
    ...
    },
    {
      ...
      "attributes": "+625 HP",
      "effect": "Passive: Have a 50% chances to block 50 damage while being attacked\nActive: Restores HP equals to 10% of their own HP for all allies within 3 grids, and has a 100% chance to block 10 damage for 10 seconds.\nCD: 30 seconds",
      "recipe": [
        "Dragonbone Shield",
        "Dragon Blood Axe"
      ],
    ...
    },
    {
      ...
      "attributes": "+8 Armor\n+15% Evasion rate",
      "effect": "Decreases ATK Speed of the attacker by 25% for 5 seconds when receiving base attacks.",
      "recipe": [
        "Lucky Coin",
        "Cattlehide Armor"
      ],
    ...
    },
    {
      ...
      "effect": "Active: Deals 300 Magical Damage to enemies within 5 grids and reduces their ATK Speed by 50% for 5 seconds. CD: 30 seconds.",
      "recipe": [
        "Dragonthorn Bracer",
        "Ice Platemail"
      ],
    ...
    },
    {
      ...
      "attributes": "+10% Lifesteal\n+50% ATK Speed",
      "effect": "Reduces enemy’s Armor by 8 with base attacks, lasts for 5 seconds",
      "recipe": [
        "Frantic Mask",
        "Wraith Shard"
      ],
    ...
    },
    {
      ...
      "attributes": "+20% Magic resistance\n+40% Mana restoration on injury",
      "effect": "Active: Provides a shield that blocks 200 Magical Damage for all allies within 3 grids for 5 seconds.\nCD: 30 seconds",
      "recipe": [
        "Anti-Maga Cloak",
        "Nether Essence"
      ],
    ...
    },
    {
      ...
      "attributes": "+25 ATK",
      "effect": "Passive: Base attack has a 25% chance to deal 100 Magical Damage to up to 3 enemies. CD: 0.5 seconds.",
      "recipe": [
        "Rune Hammer",
        "Rune Hammer"
      ],
    ...
    },
    {
      ...
      "attributes": "+100% Mana restoration on hit",
      "effect": "",
      "recipe": "",
      "sourceUrl": "https://ac.dragonest.com/en/equipment",
      "source": "Official Dragonest Item Effects",
    ...
    },
    {
      ...
      "attributes": "+50 ATK\n+30% Attack speed",
      "effect": "Passive: Base attak has a 25% chance to deal 200 damage to 5 enemies at most. CD: 0.5 seconds.",
      "recipe": [
        "Maelstorm",
        "Wraith Shard"
      ],
    ...
    {
      "id": "monkey-king-cane",
      "name": "Monkey King Cane",
      "quality": "Immortal",
      "categories": [
        "Physic"
      ],
      "attributes": "+80 ATK\n+15% Attack speed",
      "effect": "Passive: Base attack has a 100% can not be avoided and -70% target's HP restoration for 5 seconds",
      "recipe": [
        "Ghost Blade",
        "Oblivion Staff"
      ],
    ...
    {
      "id": "mysterial-staff",
      "name": "Mysterial Staff",
      "quality": "Epic",
      "categories": [
        "Magic"
      ],
      "attributes": "+15% Ability damage\n+100% Mana restoration on hit",
      "effect": "",
      "recipe": "",
      "sourceUrl": "https://ac.dragonest.com/en/equipment",
      "source": "Official Dragonest Item Effects",
    ...
    },
    {
      ...
      "attributes": "+40% Mana restoration on injury",
      "effect": "",
      "recipe": "",
      "sourceUrl": "https://ac.dragonest.com/en/equipment",
      "source": "Official Dragonest Item Effects",
    ...
    },
    {
      ...
      "attributes": "+20 ATK\n+10% Attack speed",
      "effect": "Passive: Base attack has a 35% can not be avoided and -35% target's HP restoration for 5 seconds",
      "recipe": [
        "Wooden Club",
        "Rune Hammer"
      ],
    ...
    },
    {
      ...
      "attributes": "+200% Mana restoration on hit\n+15% Ability damage",
      "effect": "Passive: Refreshes ability CD immediately after casting it.\nCD: 30 seconds",
      "recipe": [
        "Orb of Regen",
        "Mysterial Staff"
      ],
    ...
    },
    {
      ...
      "attributes": "+20% Ability damage\n+150% Mana restoration on hit",
      "effect": "Active: deals 10% of target's Max HP +450 Magical damage to 1 random enemy piece.\nCD: 15 seconds(The initial CD is 2 seconds when entering a battle.)",
      "recipe": [
        "Pulse Staff",
        "Mysterial Staff"
      ],
    ...
    },
    {
      ...
      "attributes": "+10% Ability damage\n+100% Mana restoration on hit",
      "effect": "Active: deals 350 Magical damage to 1 random enemy piece.\nCD: 15 seconds(The initial CD is 2 seconds when entering a battle.)",
      "recipe": [
        "Magicka Crystal",
        "Magicka Staff"
      ],
    ...
    },
    {
      ...
      "attributes": "+15% Magic resistance",
      "effect": "Passive: +15% lifesteal when dealing base attack to allies within 1 grids",
      "recipe": [
        "Dracula Mask",
        "Resistance Cloak"
      ],
    ...
    },
    {
      ...
      "attributes": "+15 ATK\n+350 HP",
      "effect": "Active: Increases 100% Magic Resistance, and immune to Abilities for 4 seconds. CD: 30 seconds",
      "recipe": [
        "Life Crystal",
        "Rune Hammer"
      ],
    ...
    },
    {
      ...
      "attributes": "+45% Ability damage\n+100% Mana restoration on hit",
      "effect": "Active: Hex an random enemy to a penguin for 5 seconds.\nCD: 30 seconds",
      "recipe": [
        "Mysterial Staff",
        "Voodoo Staff"
      ],
    ...
    },
    {
      ...
      "attributes": "+15% Evasion\n+15% Attack speed",
      "effect": "Passive: deals Pure Damage equals to 20% of the Attack Damage to enemies within 1 grids with melee attacks",
      "recipe": [
        "Wooden Club",
        "Lucky Coin"
      ],
    ...
    },
    {
      ...
      "attributes": "+10% Evasion Rate\n+25 ATK\n+650 Max HP",
      "effect": "The carrier gets \"Dwarf\" synergy additionally. The carrier's ranged base attack will additionally attack 2 enemies within the range, dealing damage equals to 25% ATK.",
      "recipe": [
        "Burst Rifle",
        "Dragon Blood Axe"
      ],
    ...
    },
    {
      ...
      "attributes": "+5 Armor",
      "effect": "Grants +3 Armor for allies within 1 grid",
      "recipe": [
        "Cattlehide Armor",
        "Cattlehide Armor"
      ],
    ...
    {
      "id": "teleport-dagger",
      "name": "Teleport Dagger",
      "quality": "Legendary",
      "categories": [
        "Magic"
      ],
      "attributes": "+20 ATK\n+100% Mana Restoration on hit",
      "effect": "Active: Flashes to the farthest grid that can attack the enemy and gains 50 Mana. CD: 15 seconds.",
      "recipe": [
        "Broken Sword",
        "Magicka Crystal"
      ],
